...
class HomeFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.list_home, container, false) // fragment_api.xmlが反映されたViewを作成して、returnします
    }
    ...
    private fun updateData() {
        ...
        mDatabaseReference.collection(TimetablePATH).addSnapshotListener { snapshots, e ->
            if (e != null) {
